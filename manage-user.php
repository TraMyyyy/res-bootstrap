...
<div class ="my-0 manage d-flex">
  ...
  <div class = "title m-4">
    <h1>Manage Users</h1>
    <a href="#" class = "btn bg-primary text-light">Add New User</a>
  </div>
  ...
  <div class ="table-responsive">
      ...
      <thead>
        <tr>
          ...
          <th scope="col col-auto">Full Name</th>
          <th scope="col col-auto">Username</th>
      ...
      <tbody>
        <tr>
          <th scope="row">1</th>
          <td>Arsenio Launch</td>
          <td>abcxyz</td>
          <td>
            <div class ="row">
            <a href="#" class = "col-3 col-auto rounded bg-primary text-decoration-none p-1 m-1 text-center text-light">Change Password</a>
            <a href="#" class = "col-3 col-auto rounded bg-success text-decoration-none p-1 m-1 text-center"><h3>Updated Admin</h3></a>
            <a href="#" class = "col-3 col-auto rounded bg-danger text-decoration-none p-1 m-1 text-center"><h4>Delete Admin</h4></a>
          </div>
          </td>
        </tr>
        <tr>
